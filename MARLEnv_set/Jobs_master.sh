...
# declare -a All_data=("Drone")
# declare -a All_N_agents=(5)
# declare -a All_Methods=("Quantization" "Original")
# Rounds=($(seq 1 1 1))

# declare -a All_data=("Drone")
# declare -a All_N_agents=(1 5)
...
# 				./Submit_slurm_train_MARL_Drone_AdaptiveBottlenecking.sh $data $N_agents $Method $Round
# 			done
# 		done
# 	done
# done
